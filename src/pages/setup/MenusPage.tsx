...
const DEFAULT_NAV: NavBlock[] = [
  ...
  },
  {
    ...
    submenus: [
      ...
      { name: 'Cash or USD Taken', route: '/operations/cash-usd-taken' },
      { name: 'Exchange', route: '/operations/exchange' },
  ...
  },
  {
    ...
    submenus: [
      ...
      { name: 'Expenses', route: '/management/expenses' },
      { name: 'Exchange', route: '/management/exchange' },
