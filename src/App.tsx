...
function LegacyFinancialReportsRedirect() {
  ...
  const to =
    LEGACY_FINANCIAL_KIND_TO_PATH[kind] ?? "/financial-reports/trial-balance";
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/" element={<AppLayout />}>
                ...
                <Route
                  path="expenses"
                  element={<ExpensesPage sideAction="Operation" />}
                />
                <Route
                  path="management/expenses"
                  element={<ExpensesPage sideAction="Management" />}
                />
                <Route
                  path="operations/exchange"
                  element={
                    <ExpensesPage
                      expenseKind="Exchange"
                ...
                />
                <Route
                  path="operations/cash-usd-taken"
                  element={
                    <ExpensesPage
                      expenseKind="cashOrUsdTaken"
                      sideAction="Operation"
                    />
                  }
                />
                ...
                <Route
                  path="inventory/:saleId"
                  element={<InventorySaleDetailPage />}
                />
                <Route path="rates" element={<RatesPage />} />
                <Route
                  path="generator-usage"
                  element={<GeneratorUsagePage />}
                />
                <Route
                  path="customer-fuel-givens"
                  element={<CustomerFuelGivensPage />}
                />
                <Route
                  path="customer-fuel-givens/:id"
                  element={<CustomerFuelGivenDetailsPage />}
                />
                <Route
                  path="accounting"
                ...
                />
                <Route
                  path="accounting/chart-of-accounts-tree"
                  element={<TreeChartsOfAccountsPage />}
                />
                <Route
                  path="accounting/chart-of-accounts"
                  element={
                    <Navigate to="/accounting/charts-of-accounts" replace />
                  }
                />
                <Route
                  path="accounting/manual-journal-entry/:entryId"
                  element={<JournalEntryDetailPage />}
                />
                <Route
                  path="accounting/manual-journal-entry"
                  element={<ManualJournalEntryPage />}
                />
                <Route
                  path="accounting/recurring-journals"
                  element={<RecurringJournalEntriesPage />}
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <Navigate to="/financial-reports/trial-balance" replace />
                  }
                />
                <Route
                  path="fuel-types"
                  element={<Navigate to="/setup/fuel-types" replace />}
                />
                <Route path="pumps" element={<PumpsPage />} />
                <Route path="nozzles" element={<NozzlesPage />} />
                <Route
                  path="pumps/nozzles"
                  element={<Navigate to="/nozzles" replace />}
                />
                <Route path="dipping-pumps" element={<DippingPumpsPage />} />
                <Route
                  path="pumps/dipping-pumps"
                  element={<Navigate to="/dipping-pumps" replace />}
                />
                ...
                <Route
                  path="fuel-inventory"
                  element={<BusinessFuelInventoryPage />}
                />
                <Route path="transfers" element={<TransferFuelsPage />} />
                <Route
                  path="transfer-audit-trail"
                  element={<TransferAuditTrailPage />}
                />
                <Route
                  path="fuel-inventory/transfers"
                  element={<Navigate to="/transfers" replace />}
                />
                <Route path="liter-received" element={<LiterReceivedsPage />} />
                <Route
                  path="reports/liter-received"
                  element={<LiterReceivedReportPage />}
                />
                <Route
                  path="reports/daily-cash-sales"
                  element={<DailyCashSalesReportPage />}
                />
                <Route
                  path="reports/cash-out-daily"
                  element={<Navigate to="/reports/expenses" replace />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<ExchangeReportPage />}
                />
                <Route
                  path="reports/cash-usd-taken"
                  element={<CashOrUsdTakenReportPage />}
                />
                <Route
                  path="reports/daily-fuel-given"
                  element={<DailyFuelGivenReportPage />}
                />
                <Route
                  path="reports/generator-usage"
                  element={<GeneratorUsageReportPage />}
                />
                <Route
                  path="reports/general-daily"
                  element={<GeneralDailyReportPage />}
                />
                <Route
                  path="reports/inventory-daily"
                  element={<InventoryDailyReportPage />}
                />
                <Route
                  path="reports/daily-station"
                  element={<DailyStationReportPage />}
                />
                <Route
                ...
                />
                <Route
                  path="reports/outstanding-customers"
                  element={<OutstandingCustomersReportPage />}
                />
                <Route
                  path="reports/payroll-paid"
                  element={<PayrollStatusReportPage mode="paid" />}
                />
                <Route
                  path="reports/payroll-unpaid"
                  element={<PayrollStatusReportPage mode="unpaid" />}
                />
                <Route
                  path="reports/employee-payment-history"
                  element={<EmployeePaymentHistoryReportPage />}
                />
                <Route
                  path="reports/financial"
                  element={<LegacyFinancialReportsRedirect />}
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <Navigate
                      to="/financial-reports/trial-balance?view=unadjusted"
                      replace
                    />
                  }
                />
                <Route
                  ...
                  element={
                    <Navigate
                      to="/financial-reports/trial-balance?view=adjusted"
                      replace
                    />
                  }
                />
                <Route
                  ...
                  element={
                    <Navigate
                      to="/financial-reports/trial-balance?view=postclosing"
                      replace
                    />
                  }
                />
                ...
                />
                <Route
                  path="financial-reports/profit-and-loss"
                  element={<FinancialReportsPage />}
                />
                <Route
                ...
                />
                <Route
                  path="financial-reports/capital-statement"
                  element={<FinancialReportsPage />}
                />
                <Route
                  path="financial-reports/customer-balances"
                  element={<FinancialReportsPage />}
                />
                <Route
                  path="financial-reports/supplier-balances"
                  element={<FinancialReportsPage />}
                />
                <Route
                  path="financial-reports/daily-cash-flow"
                  element={<FinancialReportsPage />}
                />
                <Route
                  path="financial-reports/report-period-view"
                  element={<FinancialReportsPage />}
                />
                <Route path="stations" element={<StationsPage />} />
                {/* Legacy URLs */}
                <Route
                  path="operations/fuel-sales"
                  element={<Navigate to="/inventory" replace />}
                />
                <Route
                ...
                />
                <Route
                  path="operations/rates"
                  element={<Navigate to="/rates" replace />}
                />
                <Route
                  path="operations/generator-usage"
                  element={<Navigate to="/generator-usage" replace />}
                />
                <Route
                  path="operations/fuel-types"
                  element={<Navigate to="/fuel-types" replace />}
                />
                <Route
                  path="operations/pumps"
